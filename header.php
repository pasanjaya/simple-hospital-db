        ...
        <div class="content row">
          <div class="col-sm-3 sidenav hidden-xs ">
            ...
            <ul class="nav nav-pills nav-stacked ">
              ...
              <li><a href="addphysician.php">Physician</a></li>
              <li><a href="addpaitent.php">Paitent</a></li>
              <li><a href="test.php">Test</a></li>
              <li><a href="ward.php">Wards</a></li>
              <li><a href="addaddmission.php">Addmission</a></li>
              <li><a href="testregister.php">Test Register</a></li>
            </ul><br>
          </div>
          <br>
